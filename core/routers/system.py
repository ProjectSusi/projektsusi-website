...
async def system_status(monitor=Depends(get_system_monitor)):
    ...
    try:
        ...
        encryption_status = is_encryption_enabled()
        ...
        if CONFIG_AVAILABLE and config:
            ...
            mfa_enabled = getattr(config, 'MFA_ENABLED', False)
        ...
        return {
            ...
            "services": {
                ...
                "encryption": {"status": "enabled" if encryption_status else "disabled"},
                "authentication": {"status": "enabled" if auth_enabled else "disabled"},
